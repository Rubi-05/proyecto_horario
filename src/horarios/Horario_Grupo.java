 ...
 * @author Derian Iqbal
 */
public class Horario_Grupo extends javax.swing.JFrame {
    

    Non_Query noquery = new Non_Query ();
    /**
     * Creates new form Horario_Grupo
     */
    public Horario_Grupo() {
        initComponents();
//        conexion.Conectar();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Horario_Grupo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Horario_Grupo().setVisible(true);
            }
        });
    }
